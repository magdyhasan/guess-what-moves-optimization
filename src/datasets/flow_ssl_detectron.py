...
class FlowSSLDetectron(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        flow_dir = Path('/storage/user/mahmo/temp/ssl-vos/data/SegTrackv2/flow_1_arflow_cityscapes_percentile_90') / self.samples[idx].replace('.flo', '.npy')
        r_flow_dir = Path('/storage/user/mahmo/temp/ssl-vos/data/SegTrackv2/flow_reverse_1_arflow_cityscapes_percentile_90') / self.r_samples[idx].replace('.flo', '.npy')
        ...
        # flow_dir = Path('/storage/user/mahmo/temp/ssl-vos/data/SegTrackv2/Flows_gap1') / self.samples[idx]
        # r_flow_dir = Path('/storage/user/mahmo/temp/ssl-vos/data/SegTrackv2/Flows_gap1') / self.r_samples[idx]
        
        # flo = read_flow(str(flow_dir), self.resolution, self.to_rgb).transpose(1, 2, 0)
        # r_flo = read_flow(str(r_flow_dir), self.resolution, self.to_rgb).transpose(1, 2, 0)
